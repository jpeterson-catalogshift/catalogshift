...
Copyright line:         © 2026 CatalogShift · Jeremy Peterson · hello@catalogshift.com
...
1. This governance document (`context_v1.2.0.md`)
...
**GitHub Repository:** https://github.com/jpeterson-catalogshift/catalogshift

If HTML or CSS files are not provided as uploads at session start, Claude should fetch them directly from GitHub before making any changes.

**Site pages**
```
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/index.html
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/about.html
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/work.html
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/contact.html
```

**Stylesheet**
```
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/assets/style.css
```
Note: style.css lives in `assets/` only. A duplicate at the repo root was removed on 2026-03-09. If a future session sees a root-level style.css, it is a stale file and should not be used.

**Logo and favicon files**
```
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/assets/logo/catalogshift-logo-vg.svg
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/assets/logo/catalogshift_logo.png
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/assets/logo/catalogshift-favicon32.png
https://raw.githubusercontent.com/jpeterson-catalogshift/catalogshift/main/assets/logo/catalogshiftfavicon-16.png
```

**GitHub folder browser URLs (for navigation/reference)**
```
https://github.com/jpeterson-catalogshift/catalogshift/tree/main
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/assets
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/assets/images
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/assets/logo
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/framework
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/infrastructure
https://github.com/jpeterson-catalogshift/catalogshift/tree/main/research
```

**Priority order for accessing site files:**
1. Files uploaded directly to the session (fastest, most reliable)
2. Fetch from GitHub raw URLs above (if repo is public and files not uploaded)
3. Ask the owner to upload the file (if repo is private or fetch fails)

Claude must never edit a file it has not read in the current session.
...
**The approval step is mandatory and non-skippable:**

1. Claude presents the KEEP / CHANGE / WHY for the proposed change
2. Claude stops and waits for explicit owner confirmation
3. Owner confirms with a clear "yes", "approved", "proceed", or equivalent
4. Only after confirmation does Claude make any edits

Claude must never present a KEEP / CHANGE / WHY and immediately proceed. Presenting the protocol and executing in the same response is a violation — even if the change seems minor or obvious. If the owner has not responded to the KEEP / CHANGE / WHY, no edits are made.
...
| 2026-03-08 | Footer nav links removed (Work · About · Contact) | Duplicate of main nav — created visual confusion on ultrawide screens where footer was visible simultaneously with nav |
| 2026-03-08 | CTA button text changed to "Email CatalogShift" | Brand name more professional than "Email Jeremy" or "Email me" in primary CTA context |
| 2026-03-08 | CSS post-launch fixes applied | Nav link contrast (#8892A4 → #c8d0e8), scroll hint opacity (0.18 → 0.5), nav z-index (200 → 500), section min-height: 60vh, nav-cta white-space: nowrap for mobile |
